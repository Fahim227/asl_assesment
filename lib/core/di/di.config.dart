...
import 'package:asl_assesment/core/network/network_client.dart' as _i10;
import 'package:asl_assesment/core/network/private_network_client.dart' as _i11;
...
extension GetItInjectableX on _i1.GetIt {
  ...
  _i1.GetIt init({
    ...
    gh.factory<_i3.Mapper<_i7.PostResponseModel, _i8.PostResponseEntity>>(
        () => _i9.PostResponseModelToEntity());
    gh.singleton<_i10.NetworkClient>(_i11.PrivateNetworkClient());
    gh.factory<_i12.PostsDataSource>(
        () => _i13.PostsDataSourceImpl(gh<_i10.NetworkClient>()));
    gh.factory<_i14.PostsRepository>(() => _i15.PostsRepositoryImpl(
          gh<_i12.PostsDataSource>(),
          gh<_i3.Mapper<List<_i4.PostModel>, List<_i5.PostEntity>>>(),
        ));
    gh.factory<_i16.AddItemDataSource>(
        () => _i17.AddItemDataSourceImpl(gh<_i10.NetworkClient>()));
    gh.factory<_i18.AddItemRepository>(() => _i19.AddItemRepositoryImpl(
          gh<_i16.AddItemDataSource>(),
          gh<_i3.Mapper<_i7.PostResponseModel, _i8.PostResponseEntity>>(),
        ));
    gh.factory<_i20.AddItemUseCase>(
        () => _i20.AddItemUseCase(gh<_i18.AddItemRepository>()));
    gh.factory<_i21.GetAllPostedItems>(
        () => _i21.GetAllPostedItems(gh<_i14.PostsRepository>()));
    gh.factory<_i22.PostsCubit>(
        () => _i22.PostsCubit(getAllPostedItems: gh<_i21.GetAllPostedItems>()));
    gh.factory<_i23.AddItemFormCubit>(
        () => _i23.AddItemFormCubit(gh<_i20.AddItemUseCase>()));
    return this;
  }
}
